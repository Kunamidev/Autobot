...
module.exports.run = async function ({ api, event, args }) {
    try {
        ...
        if (!prompt) {
            return api.sendMessage(formatFont('(❓) Please provide a question or message to Llama 3 70B.'), event.threadID, messageID);
        }
        ...
        const rona = `https://joshweb.click/api/llama-3-70b?q=${encodeURIComponent(prompt)}`;
        ...
        if (response.data && response.data.response) {
            ...
            // AI Answer Here
            api.sendMessage(formatFont(`🎓 Llama 3 70B Answer\n━━━━━━━━━━━━━━━━\n\n🖋️ Query: '${prompt}'\n\nAnswer: ${generatedText}\n\n🗓️ | ⏰ Date & Time:\n.⋅ ۵ ${formattedDateTime} ۵ ⋅.\n\n━━━━━━━━━━━━━━━━`), event.threadID, messageID);
        } else {
