...
module.exports.run = async function ({ api, event, args }) {
    try {
        ...
        const llama_api = `https://openapi-idk8.onrender.com/llama?query=${encodeURIComponent(prompt)}`;
