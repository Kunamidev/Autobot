...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/100077070762554";
		const BOTCREATOR = "Heru";
		const BOTNAME = "Autobot";
		const FILESOWNER = "Developer";
...
♛ Bot Admin Link: https://www.facebook.com/100077070762554
❂ Bot Prefix: ${prefix}
